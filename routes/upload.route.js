...
module.exports = function (router) {
  ...
  router.post("/upload/create", [authMiddleware.validateToken, uploadMiddleware.upload.single("upload")], uploadController.createImage)
  router.post("/upload/createMulti", [authMiddleware.validateToken, uploadMiddleware.upload.array("upload")], uploadController.createMultiImage)
